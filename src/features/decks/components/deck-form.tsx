	...
	return (
		...
		>
			<Textarea
				...
				className="min-h-24 resize-none rounded-2xl border-input bg-background px-4 py-3 text-base focus-visible:border-brand focus-visible:ring-brand/20 dark:bg-background md:text-base"
			/>
